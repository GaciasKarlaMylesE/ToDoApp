...
class _TaskItemState extends State<TaskItem> {
  Future<void> _handleTaskCompletionToggle() async {
    widget.task.isDone = !widget.task.isDone;
    await FirebaseUtils.updateTaskCompletionStatus(
      widget.task.id!,
      widget.task.isDone,
    );
  }
            ...
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: () async {
                    await _handleTaskCompletionToggle();
                    setState(() {}); // Update UI after completion toggle
                  },
